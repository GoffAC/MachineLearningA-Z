...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 11 15:46:28 2018
...
#INPUT CLASSIFIER HERE_____________________
...
#make it easier to see all our points and essentially have padding to the axis (hence min and max) 
#Step is the resolution of the placement of dots 
X1, X2 = np.meshgrid(np.arange(start = X2_set[:, 0].min() - 1, stop = X2_set[:, 0].max() + 1, step = 0.01),
